...
describe('#readFileAsync()', function () {
  ...
  it('should read a file by promise and return an object with given testfile.json', function (done) {
    readFileAsync('./test/testfile.json').then(function (data) {
      try {
        var obj = JSON.parse(data.toString());
...
//# sourceMappingURL=/Users/PureWind/Documents/githubProject/summer_js/js543/transpiled/test/test.js.map